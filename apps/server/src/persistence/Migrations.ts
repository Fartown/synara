...
import Migration0073 from "./Migrations/073_ExternalAutoImportState.ts";
import Migration0074 from "./Migrations/074_BackfillExternalImportThreadIds.ts";
...
export const migrationEntries = [
  ...
  [73, "ExternalAutoImportState", Migration0073],
  [74, "BackfillExternalImportThreadIds", Migration0074],
] as const;
